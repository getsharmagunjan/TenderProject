...
<form method="post" style="height: 394px; width: 685px" class="style8" action="page2.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<strong>Item name contains&nbsp;&nbsp;&nbsp;
	<input name="name" type="text" style="width: 160px; height: 30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input name="submit" type="submit" value="Search" style="width: 110px; height: 30px">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<% 
	 	...
	 	try
	 	{
	 		String sql="select * from items where itemname like '%"+name+"%' order by seller, itemid desc";
...
&nbsp;&nbsp; <br />
&nbsp;&nbsp;<a href="page2.jsp"><input name="Button2" type="button" value="Tenders By Name" style="width: 240px; height: 30px; font-weight: bold; background-color: #B9B9FF;" /></a><br />
	<br />
&nbsp;
<a href="page3.jsp">
