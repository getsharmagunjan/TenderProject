...
<%
	...
	String bTo="";
%>
<form method="post" style="height: 394px; width: 685px" class="style8" action="page3.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<br>
	&nbsp;
	<strong>Item Value Starts From&nbsp;&nbsp;&nbsp;
	<input name="From" type="text" style="width: 160px; height: 30px" value='<%=bFrom%>'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input name="To" type="text" style="width: 160px; height: 30px" value='<%=bTo%>'>&nbsp;&nbsp
	<input name="submit" type="submit" value="Search" style="width: 100px; height: 30px">
	
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</strong>
	<% 
	 	bFrom=request.getParameter("From");
	 	bTo=request.getParameter("To");
	 	//int from = Integer.parseInt(bFrom);
	 	//int to = Integer.parseInt(bTo);
	 	...
	 	{
	 		String cond;
	 		if  (( bFrom.length() >  0 ) && (bTo.length() > 0))
     		{
     			cond = "initprice >= "+bFrom+" and highestbid <= "+bTo;
     		}
     		else if  (( bFrom.length() ==  0 ) && (bTo.length() == 0))
     		{
     			cond = "initprice >= 0 or highestbid <= 0";
     		}
     		else if  (( bFrom.length() >  0 ) && (bTo.length() == 0))
     		{
     			cond = "initprice >= "+bFrom;
     		}
     		else
     		{
     			cond = "highestbid <= "+bTo;
	 		...
	 		ResultSet rs = tdf.fetchData(query);
	 		if(rs.first()==false)
	 		{
	 			if(request.getParameter("From").equals(""))
	 			{
...
%>
		...
		<tr bgcolor="#3399FF">
			...
			<th style="color:white; width: 110px;"><B>Initial Price</B></th>
...
<%
	 ...
	 %>
	 	<tr>
			...
			<td style="width: 110px"><%=rs.getInt("initprice")%></td>
...
&nbsp;
<a href="page3.jsp">
	<input name="Button3" type="button" value="Tenders By Value" style="width: 240px; height: 30px; font-weight: bold; background-color:#B9B9FF;" /></a><br />
	<br />
&nbsp;
<a href="page4.jsp">
